<div id="post-<?php the_ID(); ?>"<?php post_class(); ?>>
    ...
    <div class="post-content-single">
        ...
        <div class="post-content-inner">
			...
			wp_link_pages( array(
				...
				'link_before' => '<span>',
				'link_after'  => '</span>',
				'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'silverstorm' )
				                 . ' </span>%',
	...
	the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Next:', 'silverstorm' )
		               . '</span> ' .
		               '<span class="screen-reader-text">' . esc_html__( 'Next post:', 'silverstorm' ) . '</span> ' .
		...
		'prev_text' => '<i class="font-icon-post fa fa-angle-double-left"></i>' .
		               '<span class="meta-nav" aria-hidden="true">' . esc_html__( 'Previous:', 'silverstorm' )
		               . '</span> ' .
		               '<span class="screen-reader-text">' . esc_html__( 'Previous post:', 'silverstorm' )
		               . '</span> ' .
