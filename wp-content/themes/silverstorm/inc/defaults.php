<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            $theme_click_pen_to_edit_title = __('stunning  Creation', 'silverstorm');
    ...
    $silverstorm_theme_svg_icons = array(
		'fort-awesome'  => array(
	...
	$silverstorm_theme_divider_style = array(
	...
	$silverstorm_title = "stunning Creation";
	$silverstorm_lorem_ipsum = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.";
	...
	$defaults = array(
		...
		"edit_this_text_in_customizer"      => $silverstorm_title,
		'lorem_ipsum'                       => $silverstorm_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(196, 196, 202)',
		'blog_post_excerpt_length'          => 13,
		'assets_js_key'                     => "silverstormFrontendData",

		'default_icon'                      => $silverstorm_theme_svg_icons['fort-awesome'],
		'icons'                             => $silverstorm_theme_svg_icons,
		'divider_style'                     => $silverstorm_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
				...
				"style"             => array(
					...
					"background" => array(
						...
						"slideshow" => array(
							...
							"slides"   => array(
								array(
									'url' => $theme_directory_uri . "/resources/images/slide-1.jpg",
								),
								array(
									'url' => $theme_directory_uri . "/resources/images/slide-2.jpg",
								),
							)
						),
						"video"     => array(
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $silverstorm_theme_svg_icons['facebook-2'],
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $silverstorm_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $silverstorm_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $silverstorm_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $silverstorm_theme_svg_icons['map-marker'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $silverstorm_theme_svg_icons['phone'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $silverstorm_theme_svg_icons['envelope'],
